...
const Scoreboard = ({ currentScore, totalScore }: Props) => {
  return (
    <div className="flex w-full flex-col items-center gap-2">
      <div className="flex w-11/12 rounded-5 border-4 border-gray-300 bg-white px-2 outline outline-2 outline-gray-600">
        ...
        <p
          className={`${scoreFont.className} flex items-center text-6xl text-gray-700 drop-shadow-soft`}
        >
